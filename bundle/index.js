...
let idMember; //array 1 type
let dataMember; // array multitype
...
let newTalent; //saya menggunakan kembali template data object data user yang didalamnya berisi data yang ada istrinya dan belum beristri
newTalent = [
    {
        id: 99,
        nama: "samsul",
...
//arrow funct
const exaplArrFunc = () => 'ini data hasil arrow function';
...
const lahir = 2002; //ini contoh data dummy 
const sekarang = 2024;
const hitungUmurSaya = (param1, param2) => {
